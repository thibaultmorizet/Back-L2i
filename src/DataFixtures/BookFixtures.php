...
class BookFixtures extends Fixture
{
    ...
    public function load(ObjectManager $manager)
    {
        ...
        $categories[0]->setName("Programmation et langages");
        $manager->persist($categories[0]);

        $categories[1] = new Category();
        $categories[1]->setName("Réseaux et télécommunication");
        $manager->persist($categories[1]);

        $categories[2] = new Category();
        $categories[2]->setName("Base de données");
        ...
        $livres[0]->addCategory($categories[0]);
        ...
        $livres[1]->addCategory($categories[0]);
...
Coder proprement est décomposé en trois parties. La première décrit les principes, les motifs et les pratiques employés dans l'écriture d'un code propre. La deuxième est constituée de plusieurs études de cas à la complexité croissante. Chacune d'elles est un exercice de nettoyage: vous partirez d'un exemple de code présentant certains problèmes, et l'auteur vous expliquera comment en obtenir une version saine et performante. La troisième partie, enfin, sera votre récompense. Son unique chapitre contient une liste d'indicateurs éprouvés par l'auteur qui vous seront précieux pour repérer efficacement les défauts de votre code.
        ...
        $livres[2]->addCategory($categories[0]);
        ...
        $livres[3]->addCategory($categories[2]);
        ...
        $livres[4]->addCategory($categories[0]);
        ...
        $livres[5]->addCategory($categories[0]);
        ...
        $livres[6]->addCategory($categories[1]);
        ...
        $livres[7]->addCategory($categories[0]);
        ...
        $livres[8]->addCategory($categories[0]);
...
Coder proprement est décomposé en trois parties. La première décrit les principes, les motifs et les pratiques employés dans l'écriture d'un code propre. La deuxième est constituée de plusieurs études de cas à la complexité croissante. Chacune d'elles est un exercice de nettoyage: vous partirez d'un exemple de code présentant certains problèmes, et l'auteur vous expliquera comment en obtenir une version saine et performante. La troisième partie, enfin, sera votre récompense. Son unique chapitre contient une liste d'indicateurs éprouvés par l'auteur qui vous seront précieux pour repérer efficacement les défauts de votre code.
        ...
        $livres[9]->addCategory($categories[0]);
        ...
        $livres[10]->addCategory($categories[2]);
        ...
        $livres[11]->addCategory($categories[0]);
        ...
        $livres[12]->addCategory($categories[0]);
        ...
        $livres[13]->addCategory($categories[1]);
        ...
        $livres[14]->addCategory($categories[0]);
        ...
        $livres[15]->addCategory($categories[0]);
...
Coder proprement est décomposé en trois parties. La première décrit les principes, les motifs et les pratiques employés dans l'écriture d'un code propre. La deuxième est constituée de plusieurs études de cas à la complexité croissante. Chacune d'elles est un exercice de nettoyage: vous partirez d'un exemple de code présentant certains problèmes, et l'auteur vous expliquera comment en obtenir une version saine et performante. La troisième partie, enfin, sera votre récompense. Son unique chapitre contient une liste d'indicateurs éprouvés par l'auteur qui vous seront précieux pour repérer efficacement les défauts de votre code.
        ...
        $livres[16]->addCategory($categories[0]);
        ...
        $livres[17]->addCategory($categories[2]);
        ...
        $livres[18]->addCategory($categories[0]);
        ...
        $livres[19]->addCategory($categories[0]);
        ...
        $livres[20]->addCategory($categories[1]);
        ...
        $livres[21]->addCategory($categories[0]);
        ...
        $livres[22]->addCategory($categories[0]);
...
Coder proprement est décomposé en trois parties. La première décrit les principes, les motifs et les pratiques employés dans l'écriture d'un code propre. La deuxième est constituée de plusieurs études de cas à la complexité croissante. Chacune d'elles est un exercice de nettoyage: vous partirez d'un exemple de code présentant certains problèmes, et l'auteur vous expliquera comment en obtenir une version saine et performante. La troisième partie, enfin, sera votre récompense. Son unique chapitre contient une liste d'indicateurs éprouvés par l'auteur qui vous seront précieux pour repérer efficacement les défauts de votre code.
        ...
        $livres[23]->addCategory($categories[0]);
        ...
        $livres[24]->addCategory($categories[2]);
        ...
        $livres[25]->addCategory($categories[0]);
        ...
        $livres[26]->addCategory($categories[0]);
        ...
        $livres[27]->addCategory($categories[1]);
